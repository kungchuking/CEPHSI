...
class CFusion(nn.Module):
    ...
    def forward(self, x, c):
        """
        Fuses (i.e. elementwise addition and multiplication) the temporal embeddings
        with the spatial counterpart.
        Args:
            X:
                -- Spatial embeddings generated by performing a 32 output channel
                   convolution on the blurry image.
            cond:
                -- Temporal embeddings, which are represented by a vector of 256
                   elements.
        """
        ...
        # -- The original shape of c is 256.
        # -- Split them into two: one half goes to c1, and the other goes to c2.
        # -- Add a new axis on the left, and two more on the right
        # -- The resulting shape should be [1, 128, 1, 1]
        # -- This is so that the number of dimensions of c1/c2 match that of the 
        #    spatial embeddings for broadcasting during multiplication.
        # -- This also implies that the spatial embeddings, x, has 128 channels
...
class CUnet(nn.Module):
    ...
    def forward(self, x, cond):
        """
        Corresponds to implicit neural representation (INRV) for videos and returns
        frame features.
        Args:
            X:
                -- Spatial embeddings generated by performing a 32 output channel
            ...
            cond:
                -- Temporal embeddings, which are represented by a vector of 256
                   elements.
                -- The vector is generated by feeding the frequency position encoding (i.e.
                   a vector of length 160) through a 256 output channel MLPs.
                -- In terms of coded-exposure photography (CEP), each vector 
                   represents a mask.
        """
        n, c, h, w = x.shape
